...
function firstFloor(){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $(".Breadcrumb .breadcrumb .active").html(title);
                var firstFloor = $('<section class="section-floor first-floor">\
                    <p class="title"><b>【求助】</b>'+data.tieziTitle+'</p>\
                <div class="content">\
                    <div class="user-information">\
                    <p class="user-id">'+data.tieziCreater+'</p>\
                    <div class="user-touxiang">\
                    <img src="../php/upload/0a10a3001add5372d597720b43bda107">\
                ...
                <div class="section-footer">\
                    ...
                    <button class="btn proven">举报</button>\
                    </div>\
                    </div>\
                    </div>\
                    </div>\
